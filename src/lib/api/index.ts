...
// 粘贴引擎
export { pasteText, pasteTextGuarded, pasteRich, pasteRichGuarded, pasteImage, copyOnly, readClipboardText, copyImageOnly, copyRichOnly, copyFiles, copyItemToClipboard, saveForeground, toggleWindow } from "./paste";
